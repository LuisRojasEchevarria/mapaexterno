...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    if(isset($_GET["cl"])){
      $val_password = urldecode($_GET["cl"]);
    }
    ...
    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
      <div class="form-group has-feedback">
        <input id="email" name="email" type="text" class="form-control" placeholder="Email" autofocus maxlength="45" value="<?php echo $val_usuario; ?>" >
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        <?php echo form_error('email');?>
      </div>
      <div class="form-group has-feedback">
        <input id="pass" name="pass" type="password" class="form-control" placeholder="Password" maxlength="45" value="<?php echo $val_password; ?>" >
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-5">
          <button id="btn_accion" type="submit" class="btn btn-primary btn-block btn-flat">Iniciar sesión</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
