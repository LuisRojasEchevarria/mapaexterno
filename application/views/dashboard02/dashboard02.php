...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <h3 class="box-title"><b>DASHBOARD 02</b></h3>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <img id="foto_jefe_proyecto" class="profile-user-img img-responsive" src="" alt="User profile picture">
    ...
    <div class="box-body no-padding">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
          ...
          <!-- /.box -->
            ...
            <!-- Detalle Avance -->
            <div id="tabla-avance-container"></div>
            <input type="hidden" id="avance-data-input" value="">
            <!-- /Detalle Avance -->
...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-primary">
        <div class="inner">
            <h3 id="area_construida_tierra">0</h3>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
        <div class="inner">
            <h3 id="area_construida_mar">0</h3>
...
<div class="gallery">
    <figure class="gallery__item gallery__item--1">
        <img id="imagen01" src="<?php echo $base_url.'upload/obra/muelle0.png' ?>" alt="Gallery image 1" class="gallery__img">
    </figure>
    <figure class="gallery__item gallery__item--2">
        <img id="imagen02" src="<?php echo $base_url.'upload/obra/muelle1.png' ?>" alt="Gallery image 2" class="gallery__img">
    </figure>
    <figure class="gallery__item gallery__item--3">
        <img id="imagen03" src="<?php echo $base_url.'upload/obra/muelle2.png' ?>" alt="Gallery image 3" class="gallery__img">
    </figure>
    <figure class="gallery__item gallery__item--4">
        <img id="imagen04" src="<?php echo $base_url.'upload/obra/muelle3.png' ?>" alt="Gallery image 4" class="gallery__img">
    </figure>
    <figure class="gallery__item gallery__item--5">
        <img id="imagen05" src="<?php echo $base_url.'upload/obra/muelle4.png' ?>" alt="Gallery image 5" class="gallery__img">
    </figure>
</div>
...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
    ...
    <!-- /.box-header -->
    <div class="box-body no-padding">
        <ul id="equipo" class="users-list clearfix">
        </ul>
        <!-- /.users-list -->
    </div>
    <!-- /.box-body -->
