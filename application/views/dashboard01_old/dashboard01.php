...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="box-body">
                ...
                <div class="chart">
                <!-- Sales Chart Canvas -->
                    <canvas id="barChart02" style="height: 300px;"></canvas>
                </div>
                <!-- /.chart-responsive -->
                <!-- /.col -->
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="box-body no-padding">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <img src="<?php echo $base_url.'upload/obra/avance.png' ?>" alt="User Image">
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <tr>
                ...
                <td><span class="badge bg-navy">55%</span></td>
            </tr>
            <tr>
                <td>2.</td>
                ...
                <td><span class="badge bg-navy">70%</span></td>
            </tr>
            <tr>
                <td>3.</td>
                ...
                <td><span class="badge bg-navy">30%</span></td>
            </tr>
            <tr>
                <td>4.</td>
                ...
                <td>
                <div class="progress progress-xs">
                    <div class="progress-bar progress-bar-teal" style="width: 90%"></div>
                </div>
                </td>
                <td><span class="badge bg-navy">90%</span></td>
            </tr>
            </table>
