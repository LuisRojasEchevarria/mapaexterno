    ...
    <div class="form-body">
        ...
        <div class="form-group row">
            <div class="validar col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input id="codigo" name="codigo" type="number" class="form-control text-center" placeholder="" value="<?php echo $fila->I_COD; ?>" readonly>
            </div>       
        </div>
        ...
        <div class="form-group row">
            <div class="validar col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input id="nombre" name="nombre" type="text" class="form-control text-center" placeholder="" value="<?php echo $fila->V_NOM; ?>" maxlength="100" readonly>
            </div>       
        </div>
        ...
        <div class="form-group row">
            <div class="validar col-xs-12 col-sm-12 col-md-12 col-lg-12"  >
                ...
                <textarea id="descripcion" name="descripcion" class="form-control" placeholder="Ingrese la descripción" maxlength="500" readonly><?php echo $fila->V_DESC; ?></textarea>
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="validar col-xs-12 col-sm-12 col-md-12 col-lg-12"  >
                ...
                <input id="flag" name="flag" type="number" class="form-control text-center" placeholder="" value="<?php echo $fila->I_FLAG; ?>" maxlength="100" readonly>
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="validar col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input id="tipo" name="tipo" type="text" class="form-control text-center" placeholder="" value="<?php echo $fila->V_TIPO; ?>" readonly>
            </div>       
        </div>
