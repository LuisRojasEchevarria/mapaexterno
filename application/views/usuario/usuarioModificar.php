<div class="modal-header bg-primary">
    <button type="button" class="close" id="modificar-usuario-cerrar-btn" data-dismiss="modal">&times;</button>
    <h5 class="modal-title"></h5>
</div>

<div class="modal-body">
    <form id="form_modificar_usuario" class="form-horizontal" role="form" method="post" action="">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="validar form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="nomape" name="nomape" type="text" class="form-control text-center"  placeholder="" value="<?php echo $fila->V_NOMAPE; ?>" minlength="3" required>
                    </div>    
                </div>       
                ...
                <div class="validar form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="usuario" name="usuario" type="text" class="form-control text-center"  placeholder="" value="<?php echo $fila->V_USUARIO; ?>" minlength="3" required>
                    </div>
                </div>
                ...
                <div class="validar form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="numdoc" name="numdoc" type="text" class="form-control text-center"  placeholder="" value="<?php echo $fila->V_NUM_DOC; ?>" minlength="3" required>
                    </div>
                </div>
...
<div class="modal-footer">
    <div id="modificar-usuario-dialog-error" class="alert-custom alert" style="width: 70%;"></div>
    <div id="modificar-usuario-dialog-loading" class="loading-custom text-gray-no-line-height"><i class="fa fa-refresh fa-spin fa-fw"></i></div>
    <button type="button" class="btn btn-primary btn-tiny" id="modificar-usuario-aplicar-btn">Guardar</button>
    <button type="button" class="btn btn-default btn-tiny" id="modificar-usuario-cancelar-btn" data-dismiss="modal">Salir</button>
</div>

<!-- JS de página -->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/usuario/usuarioModificar.js"></script>
