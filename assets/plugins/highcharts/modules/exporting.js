...
(function(c) {
    ...
    function k(e, t, c, k) { e.hasOwnProperty(t) || (e[t] = k.apply(null, c)) }
    c = c ? c._modules : {};
    k(c, "modules/full-screen.src.js", [c["parts/Globals.js"]], function(e) {
        (e.FullScreen = function(e) { this.init(e.parentNode) }).prototype = {
            init: function(e) {
                ...
                if (c) c["catch"](function() { alert("Full screen is not supported inside a frame") })
            }
        }
    });
    ...
    k(c, "modules/exporting.src.js", [c["parts/Globals.js"], c["parts/Utilities.js"], c["mixins/navigation.js"]], function(e, c, k) {
        ...
        var A = e.doc,
            ...
            M = /firefox/i.test(H);
        x(c.lang, { viewFullscreen: "Ver en pantalla completa", printChart: "Imprimir Gráfico", downloadPNG: "Descargar imagen PNG", downloadJPEG: "Descargar imagen JPEG", downloadPDF: "Descargar documento PDF", downloadSVG: "Descargar imagen vector SVG", contextButtonTitle: "Menú contextual del gráfico" });
        c.navigation || (c.navigation = {});
        p(!0, c.navigation, { buttonOptions: { theme: {}, symbolSize: 14, symbolX: 12.5, symbolY: 10.5, align: "right", buttonSpacing: 3, height: 22, verticalAlign: "top", width: 24 } });
        p(!0, c.navigation, { menuStyle: { border: "1px solid #999999", background: "#ffffff", padding: "5px 0" }, menuItemStyle: { padding: "0.5em 1em", color: "#333333", background: "none", fontSize: K ? "14px" : "11px", transition: "background 250ms, color 250ms" }, menuItemHoverStyle: { background: "#335cad", color: "#ffffff" }, buttonOptions: { symbolFill: "#666666", symbolStroke: "#666666", symbolStrokeWidth: 3, theme: { padding: 5 } } });
        c.exporting = {
            type: "image/png",
            ...
            menuItemDefinitions: {
                viewFullscreen: { textKey: "viewFullscreen", onclick: function() { this.fullscreen = new e.FullScreen(this.container) } },
        ...
        e.post = function(a, b, f) {
            var d = w("form", p({ method: "post", action: a, enctype: "multipart/form-data" }, f), { display: "none" }, A.body);
            E(b, function(b, a) { w("input", { type: "hidden", name: a, value: b }, null, d) });
            d.submit();
            F(d)
        };
        x(C.prototype, {
            ...
            getSVG: function(a) {
                ...
                f.plotOptions = p(this.userOptions.plotOptions,
                    a && a.plotOptions);
                var d = w("div", null, { position: "absolute", top: "-9999em", width: this.chartWidth + "px", height: this.chartHeight + "px" }, A.body);
                ...
                x(f.chart, { animation: !1, renderTo: d, forExport: !0, renderer: "SVGRenderer", width: c, height: r });
                ...
                this.axes.forEach(function(b) { b.userOptions.internalKey || (b.userOptions.internalKey = e.uniqueKey()) });
            ...
            exportChart: function(a, b) {
                ...
                e.post(a.url, { filename: a.filename || this.getFilename(), type: a.type, width: a.width || 0, scale: a.scale, svg: b },
                    a.formAttributes)
            },
            print: function() {
                function a(a) {
                    (b.fixedDiv ? [b.fixedDiv, b.scrollingContainer] : [b.container]).forEach(function(b) { a.appendChild(b) })
                }
                var b = this,
                    f = [],
                    d = A.body,
                ...
                if (!b.isPrinting) {
                    ...
                    }[].forEach.call(c, function(b, a) { 1 === b.nodeType && (f[a] = b.style.display, b.style.display = "none") });
                    a(d);
                    setTimeout(function() {
                        z.focus();
                        z.print();
                        setTimeout(function() {
                            a(b.renderTo);
                            [].forEach.call(c, function(b, a) { 1 === b.nodeType && (b.style.display = f[a]) });
                            b.isPrinting = !1;
            ...
            contextMenu: function(a, b, f, d, c, r, l) {
                var g = this,
                    ...
                    v = Math.max(c, r);
                if (!h) {
                    g.exportContextMenu = g[n] = h = w("div", { className: a }, { position: "absolute", zIndex: 1E3, padding: v + "px", pointerEvents: "auto" }, g.fixedDiv || g.container);
                    var k = w("div", { className: "highcharts-menu" },
                        null, h);
                    g.styledMode || u(k, x({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, m.menuStyle));
                    h.hideMenu = function() {
                        u(h, { display: "none" });
                        l && l.setState(0);
                        g.openMenu = !1;
                    ...
                    g.exportEvents.push(y(h, "mouseleave", function() { h.hideTimer = z.setTimeout(h.hideMenu, 500) }), y(h, "mouseenter", function() { e.clearTimeout(h.hideTimer) }), y(A, "mouseup", function(b) {
                        g.pointer.inClass(b.target,
                            a) || h.hideMenu()
                    }), y(h, "click", function() { g.openMenu && h.hideMenu() }));
                    b.forEach(function(b) {
                        ...
                        if (t(b, !0)) {
                            ...
                            }, null, k), g.styledMode || (a.onmouseover = function() { u(this, m.menuItemHoverStyle) }, a.onmouseout = function() {
                                u(this,
                                    m.menuItemStyle)
            ...
            addButton: function(a) {
                ...
                if (!1 !== d.enabled) {
                    ...
                    d.text &&
                        d.symbol ? g.paddingLeft = q(g.paddingLeft, 25) : d.text || x(g, { width: d.width, height: d.height, padding: 0 });
                    b.styledMode || (g["stroke-linecap"] = "round", g.fill = q(g.fill, "#ffffff"), g.stroke = q(g.stroke, "none"));
                    var n = f.button(d.text, 0, 0, B, g, k, m).addClass(a.className).attr({ title: q(b.options.lang[d._titleKey || d.titleKey], "") });
                    ...
                    n.add(b.exportingGroup).align(x(d, { width: n.width, x: q(d.x, b.buttonOffset) }), !0, "spacingBox");
        ...
        I.menu = function(a, b, c, d) { return ["M", a, b + 2.5, "L", a + c, b + 2.5, "M", a, b + d / 2 + .5, "L", a + c, b + d / 2 + .5, "M", a, b + d - 1.5, "L", a + c, b + d - 1.5] };
