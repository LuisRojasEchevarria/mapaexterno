...
function CerrarDivDatos(){
    document.getElementById("seccion_cards").style.cssText = "position: absolute;top: 115px;right: 15px;width: 640px;display: none;transition: right 0.5s; z-index: 1997;padding-left: 0px;padding-right: 0px;height: 730px;overflow-y: auto;";
}
...
function CerrarNum(){
    document.getElementById("div_numflotante").style.cssText = "position: absolute;top: 100px;left: 20px;width: 300px;height: 300px;display: none;background-color: #d9d9d9;border-radius: 15px;z-index: 1997;padding: 0px;";
}
function CerrarDepa(){
    document.getElementById("div_listadepa").style.cssText = "position: absolute;top: 410px;left: 20px;width: 300px;height: 300px;display: none;background-color: #d9d9d9;border-radius: 15px;z-index: 1997;padding: 0px;";
}
...
function CerrarTipo(){
    document.getElementById("div_listatipo").style.cssText = "position: absolute;top: 410px;left: 20px;width: 300px;height: 300px;display: none;background-color: #d9d9d9;border-radius: 15px;z-index: 1997;padding: 0px;";
}
function AbrirListaTipo(DPA){
    console.log('valor en lista '+DPA);
...
function CerrarHabi(){
    document.getElementById("div_listahabi").style.cssText = "position: absolute;top: 410px;left: 20px;width: 300px;height: 300px;display: none;background-color: #d9d9d9;border-radius: 15px;z-index: 1997;padding: 0px;";
}
...
function CerrarTra(){
    document.getElementById("div_listatra").style.cssText = "position: absolute;top: 410px;left: 20px;width: 300px;height: 300px;display: none;background-color: #d9d9d9;border-radius: 15px;z-index: 1997;padding: 0px;";
}
...
function CerrarOpe(){
    document.getElementById("div_listaope").style.cssText = "position: absolute;top: 410px;left: 20px;width: 300px;height: 300px;display: none;background-color: #d9d9d9;border-radius: 15px;z-index: 1997;padding: 0px;";
}
                        ...
                        //Indicators
                            ...
                            '<div class="carousel-inner">'+
                                '<div class="item active">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0001.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0016.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0024.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0027.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0031.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0038.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0043.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0057.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0002.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0025.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0032.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0039.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0044.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0060.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0012.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0045.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0061.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0013.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0046.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0063.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0052.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0064.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                                '<div class="item">'+
                                    '<img src="' + window.base_url + 'assets/img/infraestructura/ilo/DJI_0053.jpg" alt="" style="width:550px; height:309px;">'+
                                '</div>'+
                            '</div>'+
